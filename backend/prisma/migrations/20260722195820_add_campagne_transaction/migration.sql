...
-- AlterTable
ALTER TABLE `transaction` ADD COLUMN `campagneId` INTEGER NULL;
...
-- AddForeignKey
ALTER TABLE `Transaction` ADD CONSTRAINT `Transaction_campagneId_fkey` FOREIGN KEY (`campagneId`) REFERENCES `Campagne`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
